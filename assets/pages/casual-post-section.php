...
<div class="post-page">
  <div class="pp-top">
    <a onClick="javascript:history.back()" class="action-button w-inline-block">
      <img src="assets/images/site-meta/arrow-left-circle.svg"   alt="" class="action-button-img" /></a>
    ...
    <div class="post-section">
      <div class="ps-info">
        <a href="#" class="link-block w-inline-block">
          <img src="assets/images/profile/<?= $post_data[0]['uprofile_photo'] ?>"   width="Auto" alt=""
            class="pcm-img" />
      ...
      <div class="ps-controls">
        ...
        <img src="assets/images/site-meta/share-android-solid.svg" alt="" id="sharethispage" class="ps-option" width="24" height="24" />
        <?php
       ...
       <div class="comments-container">
        ...
        foreach ($comments as $comment) {
          ...
          <div class="comment-card">
            <div>
              <a href="#" class="link-block w-inline-block">
                <img src="assets/images/profile/<?= $comment['uprofile_photo'] ?>"   width="Auto" alt=""
                  class="pcm-img" />
                <div class="pcm-details">
