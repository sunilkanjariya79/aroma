    ...
    <div class="form-block w-form">
      <form method="post" class="register-form" action="assets/php/action.php?register" enctype="multipart/form-data">
        ...
        <input class="log-reg-field w-input" maxlength="20" name="umail" placeholder="Enter your Email" type="email"
          required="" />
        <?= showError('umail') ?>
        <input class="log-reg-field w-input" maxlength="256" name="uname" placeholder="Enter your Name" type="text"
          required="" />
        <?= showError('uname') ?>
        <div class="lr-field-box">
          <input class="log-reg-field lg-field w-input" maxlength="256" name="username"
        ...
        <input class="log-reg-field w-input" maxlength="256" name="upassword" placeholder="Enteer tour password"
          type="text" required="">
        <?= showError('upassword') ?>
        <input class="log-reg-field w-input" maxlength="256" name="cpassword" placeholder="Confirm password" type="text"
          required="">
