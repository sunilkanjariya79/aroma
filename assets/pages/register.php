    ...
    <div class="form-block w-form">
      <form method="post" class="register-form" action="assets/php/action.php?register" enctype="multipart/form-data">
        <input type="file" name="uprofile_pic" id="uprofile_pic">
         ...
         <input class="log-reg-field w-input" value="<?=showFormaData('umail')?>" maxlength="30" name="umail" placeholder="Enter your Email" type="email"
          required="" />
        <?= showError('umail') ?>
        <input class="log-reg-field w-input" value="<?=showFormaData('uname')?>" maxlength="30" name="uname" placeholder="Enter your Name" type="text"
          required="" />
        <?= showError('uname') ?>
        <div class="lr-field-box">
          <input class="log-reg-field lg-field w-input" value="<?=showFormaData('username')?>" maxlength="20" name="username"
        ...
        <?= showError('username') ?>
        <textarea placeholder="Enter your about" maxlength="300" name="uabout"
          class="log-reg-field reg-edit-about w-input"><?=showFormaData('uabout')?></textarea>
        <?= showError('uabout') ?>
        <input type="date" class="log-reg-field" name="udate" value="<?=showFormaData('udate')?>" />
        <input class="log-reg-field w-input" maxlength="10" name="upassword" placeholder="Enter tour password"
          type="password" required="">
        <?= showError('upassword') ?>
        <input class="log-reg-field w-input" maxlength="10" name="cpassword" placeholder="Confirm password" type="password"
          required="">
