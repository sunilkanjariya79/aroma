  ...
  <div class="pop-up-window book-input hide">
    <div class="pop-up">
      ...
      <div class="pop-up-content" style="gap:20px;padding-bottom:20px">
        <input type="text" name="btitle" id="btitle" placeholder="Title" value="<?= showFormaData('btitle') ?>"
          class="log-reg-field">
        <input type="text" name="btag" id="btag" placeholder="tag" value="<?= showFormaData('btag') ?>"
          class="log-reg-field">
        <textarea placeholder="What's this book about" maxlength="220" name="babout"
          value="<?= showFormaData('babout') ?>" class="log-reg-field reg-edit-about w-input"></textarea>
